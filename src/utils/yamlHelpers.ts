...
import { Application, ApplicationMetadata, ApplicationSpec, ApplicationSource, HelmConfig, HelmParameter, ApplicationDestination, SyncPolicy, AutomatedSyncPolicy, RetryPolicy, IgnoreDifference, ApplicationInfo } from '../model/application';
import { ApplicationYaml, ApplicationYamlMetadata, ApplicationSpecYaml, ApplicationSourceYaml, HelmConfigYaml, ApplicationDestinationYaml, SyncPolicyYaml, AutomatedSyncPolicyYaml, RetryPolicyYaml, IgnoreDifferenceYaml, InfoYaml } from '../model/applicationYaml';
...
function yamlToApplicationSpec(spec: ApplicationSpecYaml): ApplicationSpec {
    const result: ApplicationSpec = {
        project: spec.project,
        source: spec.source ? yamlToApplicationSource(spec.source) : {
            repoURL: '',
            targetRevision: '',
            path: ''
        },
